...
import { getStorage, type FirebaseStorage } from "firebase/storage"; // Added import for getStorage
...
const storage: FirebaseStorage = getStorage(app); // Initialized Firebase Storage
